...
text_Baladas <- read_csv("Baladas_sin_tildes.txt", col_names = FALSE, show_col_types = FALSE)
class(text_Baladas)
...
# Reggaeton
text_Reggaeton <- unlist(c(read_csv("Reggaeton_proyecto_limpio_limpio.txt", col_names = FALSE, show_col_types = FALSE)))
...
stop_words_es <- tibble(word = unlist(c(read.table("Stop_words.txt", quote="\"", comment.char=""))), lexicon = "custom")
dim(stop_words_es)
...
negative_words <- read_csv("Negative_words.txt", col_names = "word", show_col_types = FALSE) %>%
...
```{r}
##### importar datos
text_Baladas <- unlist(c(read_csv("Baladas_sin_tildes.txt", col_names = FALSE, show_col_types = FALSE)))
...
```{r, echo = F}
##### importar datos
text_Baladas <- suppressWarnings(unlist(c(read_csv("Baladas_sin_tildes.txt", col_names = FALSE, show_col_types = FALSE))))
names(text_Baladas) <- NULL
text_Baladas <- tibble(line = 1:length(text_Baladas), text = text_Baladas)
##### tokenizar en skip-gram
text_Baladas %>%
...
```{r, echo = F}
##### importar datos
text_Reggaeton <- suppressWarnings(unlist(c(read_csv("Reggaeton_proyecto_limpio_limpio.txt", col_names = FALSE, show_col_types = FALSE))))
names(text_Reggaeton) <- NULL
text_Reggaeton <- tibble(line = 1:length(text_Reggaeton), text = text_Reggaeton)
##### tokenizar en skip-gram
text_Reggaeton %>%
